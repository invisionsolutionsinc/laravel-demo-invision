...
use App\Http\Requests\AdminUserRegister;
...
class UserController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function register(AdminUserRegister $request)
    {
        ...
        try {
            ...
            if (true) {
                return $this->successResponse($response, 'Admin Registered Successfully');
            } else {
